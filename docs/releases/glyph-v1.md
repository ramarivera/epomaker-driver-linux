...
| G05 | Macro management | JSON editor, focused keyboard recording, encoding/decoding, storage and playback bindings | Mouse recording and remaining editing workflows, delays/repeats/playback modes, mouse motion semantics, import/export compatibility and real execution |
