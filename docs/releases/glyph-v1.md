...
| G08 | Host-driven lighting | USB live-frame transport, browser screen capture and session cleanup; reusable PipeWire PCM capture | Complete vendor layout/crop and rhythm processing, audio controls and host lifecycle; verify physical LED correspondence and real capture/streaming |
