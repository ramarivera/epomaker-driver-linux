...
| G08 | Host-driven lighting | USB live-frame transport, browser screen capture with centered ratio selection/preview and session cleanup; reusable PipeWire PCM capture | Complete rhythm layout/processing, audio controls and host lifecycle; verify physical LED correspondence and real capture/streaming |
