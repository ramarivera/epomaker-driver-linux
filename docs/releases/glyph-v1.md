...
| G05 | Macro management | JSON editor, focused keyboard/mouse-button recording, encoding/decoding, storage and playback bindings | Persistent named macro library, remaining editing workflows, delays/repeats/playback modes, mouse motion semantics, import/export compatibility and real execution |
