...
normal submodes each, Fn maps, macros and magnetic-parameter reads. Thirteen
...
| Magnetic keyboards | HE60 current magnetic-field reads, firmware-dependent scaling, raw mode preservation and four submodes per profile | Magnetic setting writes, calibration, snap pairing, recovery and hardware comparison |
