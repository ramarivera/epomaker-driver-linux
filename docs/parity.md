...
[HE60 model 3746](ry5088-he60.md) adds its switch codes and catalog travel limits. [HE108 ID 3365](ry5088-he108.md) adds enabled partial USB support with source-confirmed matrices, side lighting, magnetic controls, and model-specific sleep/travel limits. [G84 HE Pro](g84-he-pro.md) adds its model-specific switch and limits. [HE65 V2](he65-v2.md) adds four-profile magnetic USB support, seven switch types, normal 24G/Bluetooth sleep timers and three knob slots. Thirty-four
models are counted as partial backends; their feature coverage differs substantially.
[Magnetic recovery](he-recovery.md) adds backup and restore for all eighteen
...
| Profiles | Model-specific profile counts and active selection; HE60 has four normal submodes per profile; model-checked configuration restore for 29 migrated keyboards and five mice; eight-profile support for five mice | Vendor export semantics and application-local magnetic caches, other models |
...
| Backups | Nine modern models' key/Fn maps, referenced macros, lighting, custom RGB pictures, sleep, debounce, OS options; RT100/Dynatab schema 6 recovery with physical Fn layer 0; eighteen magnetic models have schema 7 complete raw configuration and all 256 macros, with atomic pre-restore copies | Unreferenced macros on nonmagnetic models, screen pixels, and YC3121 manual OS options/OS-specific Fn banks |
