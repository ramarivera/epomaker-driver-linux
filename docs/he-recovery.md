...
Schema 7 supports the sixteen enabled migrated magnetic models through their USB command
...
exercise all sixteen IDs, all domains, hidden data, recovery-file collisions,
