...
Schema 7 supports the fourteen migrated magnetic models through their USB command
...
exercise all fourteen IDs, all domains, hidden data, recovery-file collisions,
