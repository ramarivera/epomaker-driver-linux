...
There are **33 partial backends, 13 catalog-only entries and zero models verified
on physical hardware**. The implemented subset comprises 28 keyboards and five mice;
17 magnetic IDs have implemented magnetic backends,
...
| RY5088 | 3662, 3664, 2762, 2883, 2465, 2586, 2870, 3691, 3692, 3703, 2761, 2959, 3746, 3365, 4071 | H60, HE68 Lite and HE108 variants; four profiles and firmware-dependent magnetic precision; timed USB calibration for enabled models; schema 7 recovery for enabled models; hardware verification outstanding |
...
The 22 RY5088-named rows include fifteen partial backends and seven catalog-only
...
limits. The seven remaining catalog-only RY5088 rows require further capability
