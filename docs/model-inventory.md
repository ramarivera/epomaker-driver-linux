...
There are **37 partial backends, 9 catalog-only entries and zero models verified
on physical hardware**. The implemented subset comprises 32 keyboards and five mice;
21 magnetic IDs have implemented magnetic backends,
...
| RY5088 | 3662, 3664, 2762, 2883, 2465, 2586, 2870, 3691, 3692, 3703, 2761, 2959, 3746, 3365, 3417, 3518, 3883, 4071, 3613 | H60, HE68 Lite, HE108, HE65 V2 and HE75 V2 variants; two profiles on 3518/3613, four on the others, with firmware-dependent magnetic precision; timed USB calibration for enabled models; schema 7 recovery for enabled models; hardware verification outstanding |
...
The 22 RY5088-named rows include nineteen partial backends and three catalog-only
...
| HE75 V2 TMR | 3613 | 3151:5054 | 660ec711.js | 16167605.js |
...
limits. The three remaining catalog-only RY5088 rows require further capability
