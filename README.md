...
sleep timers, debounce, automatic OS selection and direct USB display workflows. Their Fn
layers and recovery remain unfinished; the GUI still supports Glyph only.
